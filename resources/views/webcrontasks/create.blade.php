    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('webcrontasks.store') }}">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <label for="schedule" class="block font-medium text-sm text-gray-700">Schedule CRON Expression</label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
                                ...
                                <div class="grid grid-cols-1">
                                    ...
                                    <input placeholder="5000" type="text" name="retry_waits" id="retry_waits" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                           value="{{ old('retry_waits', '5000') }}"  required/>
                                    @error('url')
                                        <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                <div class="grid grid-cols-1">
                                    ...
                                    <select id="log_type" name="log_type" autocomplete="log_type" class="form-select rounded-md shadow-sm mt-1 block w-full">
                                        ...
                                        <option value="1">Only with error</option>
