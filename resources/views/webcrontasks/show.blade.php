        ...
        <div class="flex flex-col bg-white">
            ...
            <div>
                ...
                <div class="md:grid md:grid-cols-2 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                    ...
                    <p>
                        {{$webcrontask->schedule}}
                        @php
                            $traslation = LaraWebCronFunctions::getTraslationOfCronExpression($webcrontask->schedule);
                            $nextDate = LaraWebCronFunctions::getNextTaskRunDate($webcrontask->schedule);

                            if ( Str::length($traslation)>0 ) echo "<br>". $traslation;

                            if ( Str::length($nextDate)>0 ) echo "<br><em>Next run at: " .$nextDate ."</em>";
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex item-center justify-center">
                                                ...
                                                <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                                    <a href="{{ route('webcronresults.jsonresultdownload', $result->id) }}" class="text-blue-600 hover:text-blue-900 mb-2 mr-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-down" viewBox="0 0 16 16">
                                                            <title>Download Result for id: {{ $result->id}}</title>
